...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            CustomOption.vanillaSettings = TheOtherRolesPlugin.Instance.Config.Bind("Preset0", "バニラオプション", "");

            // Role Options
            presetSelection = CustomOption.Create(0, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "Preset"), presets, null, true);
            activateRoles = CustomOption.Create(1, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "MODロールを有効にし、バニラロールをブロックする"), true, null, true);

            if (Utilities.EventUtility.canBeEnabled) enableCodenameHorsemode = CustomOption.Create(10423, Types.General, cs(Color.green, "馬モードを有効にする"), true, null, true);
            if (Utilities.EventUtility.canBeEnabled) enableCodenameDisableHorses = CustomOption.Create(10424, Types.General, cs(Color.green, "馬モードを無効にする"), false, enableCodenameHorsemode, false);
            ...
            crewmateRolesFill = CustomOption.Create(308, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "クルーの役職を埋める\n(最小／最大を無視)"), false);
            neutralRolesCountMin = CustomOption.Create(302, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最小第三陣営役職数"), 15f, 0f, 15f, 1f);
            neutralRolesCountMax = CustomOption.Create(303, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最大第三陣営役職数"), 15f, 0f, 15f, 1f);
            impostorRolesCountMin = CustomOption.Create(304, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最小第インポスター役職数"), 15f, 0f, 15f, 1f);
            ...
            modifiersCountMin = CustomOption.Create(306, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最小オプション数"), 15f, 0f, 15f, 1f);
            modifiersCountMax = CustomOption.Create(307, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最大オプション数"), 15f, 0f, 15f, 1f);
            //ここから翻訳ツールdeeplの乱用です。ある程度は直してますが、ミスがあったらディスコ―ドまで。また開発者は日本人です(唐突)
            ...
            morphlingDuration = CustomOption.Create(22, Types.Impostor, "モーフ持続時間", 10f, 1f, 20f, 0.5f, morphlingSpawnRate);
            ...
            vampireCanKillNearGarlics = CustomOption.Create(43, Types.Impostor, "ヴァンパイアがニンニクの近くでキルすることができる", true, vampireSpawnRate);
            ...
            tricksterLightsOutCooldown = CustomOption.Create(252, Types.Impostor, "トリックスターのライトアウトクールダウン", 30f, 10f, 60f, 5f, tricksterSpawnRate);
            tricksterLightsOutDuration = CustomOption.Create(253, Types.Impostor, "トリックスターのライトアウト持続時間", 15f, 5f, 60f, 2.5f, tricksterSpawnRate);
            ...
            bountyHunterShowArrow = CustomOption.Create(324, Types.Impostor, "バウンティに矢印を向ける", true, bountyHunterSpawnRate);
            ...
            jackalKillCooldown = CustomOption.Create(221, Types.Neutral, "Jジャッカル/サイドキックキルクールダウン", 30f, 10f, 60f, 2.5f, jackalSpawnRate);
            ...
            jackalCanCreateSidekickFromImpostor = CustomOption.Create(229, Types.Neutral, "ジャッカルはインポスターを相棒にできる", true, jackalCanCreateSidekick);
            ...
            engineerNumberOfFixes = CustomOption.Create(91, Types.Crewmate, "サボタージュの修正数", 1f, 1f, 3f, 1f, engineerSpawnRate);
