...
namespace TheOtherRoles
{
    public class RoleInfo {
        ...
        public static RoleInfo mayor = new RoleInfo("メイヤー", Mayor.color, "あなたの1票は2度カウントされる", "あなたの1票は2度カウントされる", RoleId.Mayor);
        ...
        public static RoleInfo jackal = new RoleInfo("ジャッカル", Jackal.color, "すべてのクルーと、 <color=#FF1919FF>インポスターを</color> キルする", "みんなをキルしよう", RoleId.Jackal, true);
        public static RoleInfo sidekick = new RoleInfo("サイドキック", Sidekick.color, "ジャッカルのキルを手伝おう", "ジャッカルのキルを手伝おう", RoleId.Sidekick, true);
        public static RoleInfo spy = new RoleInfo("スパイ", Spy.color, "<color=#FF1919FF>インポスター</color>を混乱させよう", "インポスターを混乱させよう", RoleId.Spy);
        public static RoleInfo securityGuard = new RoleInfo("警備員", SecurityGuard.color, "通気孔を塞ぎ、カメラを設置する", "通気孔を塞ぎ、カメラを設置する", RoleId.SecurityGuard);
        public static RoleInfo arsonist = new RoleInfo("アーソニスト", Arsonist.color, "燃やしてしまおう", "燃やしてしまおう", RoleId.Arsonist, true);
        public static RoleInfo goodGuesser = new RoleInfo("ナイスゲッサー", Guesser.color, "推測して撃とう", "推測して撃とう", RoleId.NiceGuesser);
        public static RoleInfo badGuesser = new RoleInfo("イビルゲッサー", Palette.ImpostorRed, "推測して撃とう", "推測して撃とう", RoleId.EvilGuesser);
        public static RoleInfo vulture = new RoleInfo("ヴァルチャー", Vulture.color, "死体を食べよう", "死体を食べる", RoleId.Vulture, true);
        public static RoleInfo medium = new RoleInfo("霊能者", Medium.color, "死者の魂を訪ねて情報を得よう", "魂を問う", RoleId.Medium);
        ...
        public static RoleInfo crewmate = new RoleInfo("クルーメイト", Color.white, "インポスターを探そう", "インポスターを探そう", RoleId.Crewmate);
        public static RoleInfo witch = new RoleInfo("ウィッチ", Witch.color, "クルーに魔法をかけよう", "クルーに魔法をかけよう", RoleId.Witch);
        public static RoleInfo ninja = new RoleInfo("ニンジャ", Ninja.color, "クルーを驚かせてキルをしよう", "クルーを驚かせてキルをしよう", RoleId.Ninja);
        public static RoleInfo thief = new RoleInfo("シーフ", Thief.color, "キラーをキルして役職を奪おう", "キラーの役職を奪う", RoleId.Thief, true);
        ...
        public static RoleInfo vip = new RoleInfo("VIP", Color.yellow, "あなたはVIP", "あなたが死ぬと全員に通知される", RoleId.Vip, false, true);
        public static RoleInfo invert = new RoleInfo("反転", Color.yellow, "動きが逆だ", "動きが逆だ", RoleId.Invert, false, true);
